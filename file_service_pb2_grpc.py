...
class FileServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetFiles = channel.unary_unary(
                ...
                request_serializer=file__service__pb2.RetrieveRequest.SerializeToString,
                response_deserializer=file__service__pb2.RetrieveResponse.FromString,
                _registered_method=True)
...
def add_FileServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetFiles': grpc.unary_unary_rpc_method_handler(
                    servicer.GetFiles,
                    request_deserializer=file__service__pb2.RetrieveRequest.FromString,
                    response_serializer=file__service__pb2.RetrieveResponse.SerializeToString,
            ),
    }
...
class FileService(object):
    ...
    def UploadFile(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/FileService/UploadFile',
            file__service__pb2.UploadRequest.SerializeToString,
    ...
    def GetFiles(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/FileService/GetFiles',
            file__service__pb2.RetrieveRequest.SerializeToString,
            file__service__pb2.RetrieveResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
